...
class Interceptor extends \Magento\Tax\Model\Calculation implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getDefaultCustomerTaxClass($store = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::getDefaultCustomerTaxClass($store);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'deleteByRuleId');
        if (!$pluginInfo) {
            return parent::deleteByRuleId($ruleId);
        } else {
            return $this->___callPlugins('deleteByRuleId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCustomerTaxClasses');
        if (!$pluginInfo) {
            return parent::getCustomerTaxClasses($ruleId);
        } else {
            return $this->___callPlugins('getCustomerTaxClasses', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductTaxClasses');
        if (!$pluginInfo) {
            return parent::getProductTaxClasses($ruleId);
        } else {
            return $this->___callPlugins('getProductTaxClasses', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStoreRate');
        if (!$pluginInfo) {
            return parent::getStoreRate($request, $store);
        } else {
            return $this->___callPlugins('getStoreRate', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDefaultRateRequest');
        if (!$pluginInfo) {
            return parent::getDefaultRateRequest($store, $customerId);
        } else {
            return $this->___callPlugins('getDefaultRateRequest', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRateRequest');
        if (!$pluginInfo) {
            return parent::getRateRequest($shippingAddress, $billingAddress, $customerTaxClass, $store, $customerId);
        } else {
            return $this->___callPlugins('getRateRequest', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAppliedRates');
        if (!$pluginInfo) {
            return parent::getAppliedRates($request);
        } else {
            return $this->___callPlugins('getAppliedRates', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'reproduceProcess');
        if (!$pluginInfo) {
            return parent::reproduceProcess($rates);
        } else {
            return $this->___callPlugins('reproduceProcess', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'calcTaxAmount');
        if (!$pluginInfo) {
            return parent::calcTaxAmount($price, $taxRate, $priceIncludeTax, $round);
        } else {
            return $this->___callPlugins('calcTaxAmount', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTaxRates');
        if (!$pluginInfo) {
            return parent::getTaxRates($billingAddress, $shippingAddress, $customerTaxClassId);
        } else {
            return $this->___callPlugins('getTaxRates', func_get_args(), $pluginInfo);
        }
    }
