...
class Interceptor extends \Magento\Sales\Block\Adminhtml\Order\View implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getEditUrl()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getEditUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getEmailUrl()
    {
        ...
        if (!$pluginInfo) {
            return parent::getEmailUrl();
        } else {
            return $this->___callPlugins('getEmailUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCancelUrl()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getCancelUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getInvoiceUrl()
    {
        ...
        if (!$pluginInfo) {
            return parent::getInvoiceUrl();
        } else {
            return $this->___callPlugins('getInvoiceUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCreditmemoUrl()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCreditmemoUrl();
        } else {
            return $this->___callPlugins('getCreditmemoUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getHoldUrl()
    {
        ...
        if (!$pluginInfo) {
            return parent::getHoldUrl();
        } else {
            return $this->___callPlugins('getHoldUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getUnholdUrl()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getUnholdUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getShipUrl()
    {
        ...
        if (!$pluginInfo) {
            return parent::getShipUrl();
        } else {
            return $this->___callPlugins('getShipUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCommentUrl()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getCommentUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getReorderUrl()
    {
        ...
        if (!$pluginInfo) {
            return parent::getReorderUrl();
        } else {
            return $this->___callPlugins('getReorderUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getVoidPaymentUrl()
    {
        ...
        if (!$pluginInfo) {
            return parent::getVoidPaymentUrl();
        } else {
            return $this->___callPlugins('getVoidPaymentUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getReviewPaymentUrl($action)
    {
        ...
        if (!$pluginInfo) {
            return parent::getReviewPaymentUrl($action);
        } else {
            return $this->___callPlugins('getReviewPaymentUrl', func_get_args(), $pluginInfo);
        }
    }
