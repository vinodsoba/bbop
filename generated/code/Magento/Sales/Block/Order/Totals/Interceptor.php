...
class Interceptor extends \Magento\Sales\Block\Order\Totals implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addTotalBefore');
        if (!$pluginInfo) {
            return parent::addTotalBefore($total, $before);
        } else {
            return $this->___callPlugins('addTotalBefore', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getTotal($code)
    {
        ...
        if (!$pluginInfo) {
            return parent::getTotal($code);
        } else {
            return $this->___callPlugins('getTotal', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'removeTotal');
        if (!$pluginInfo) {
            return parent::removeTotal($code);
        } else {
            return $this->___callPlugins('removeTotal', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'applySortOrder');
        if (!$pluginInfo) {
            return parent::applySortOrder($order);
        } else {
            return $this->___callPlugins('applySortOrder', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'formatValue');
        if (!$pluginInfo) {
            return parent::formatValue($total);
        } else {
            return $this->___callPlugins('formatValue', func_get_args(), $pluginInfo);
        }
    }
