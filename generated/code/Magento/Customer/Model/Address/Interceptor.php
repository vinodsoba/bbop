...
class Interceptor extends \Magento\Customer\Model\Address implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDefaultAttributeCodes');
        if (!$pluginInfo) {
            return parent::getDefaultAttributeCodes();
        } else {
            return $this->___callPlugins('getDefaultAttributeCodes', func_get_args(), $pluginInfo);
        }
    }
