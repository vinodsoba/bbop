...
class Interceptor extends \Magento\Checkout\Block\Cart\Grid implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemsForGrid');
        if (!$pluginInfo) {
            return parent::getItemsForGrid();
        } else {
            return $this->___callPlugins('getItemsForGrid', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'prepareItemUrls');
        if (!$pluginInfo) {
            return parent::prepareItemUrls();
        } else {
            return $this->___callPlugins('prepareItemUrls', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasError');
        if (!$pluginInfo) {
            return parent::hasError();
        } else {
            return $this->___callPlugins('hasError', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isWishlistActive');
        if (!$pluginInfo) {
            return parent::isWishlistActive();
        } else {
            return $this->___callPlugins('isWishlistActive', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getContinueShoppingUrl');
        if (!$pluginInfo) {
            return parent::getContinueShoppingUrl();
        } else {
            return $this->___callPlugins('getContinueShoppingUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getMethods($alias)
    {
        ...
        if (!$pluginInfo) {
            return parent::getMethods($alias);
        } else {
            return $this->___callPlugins('getMethods', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMethodHtml');
        if (!$pluginInfo) {
            return parent::getMethodHtml($name);
        } else {
            return $this->___callPlugins('getMethodHtml', func_get_args(), $pluginInfo);
        }
    }
