...
class Interceptor extends \StripeIntegration\Payments\Model\Method\Fpx implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'createPaymentMethod');
        if (!$pluginInfo) {
            return parent::createPaymentMethod();
        } else {
            return $this->___callPlugins('createPaymentMethod', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'adjustParamsForPaymentIntent');
        if (!$pluginInfo) {
            return parent::adjustParamsForPaymentIntent($params, $order);
        } else {
            return $this->___callPlugins('adjustParamsForPaymentIntent', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'createPaymentIntent');
        if (!$pluginInfo) {
            return parent::createPaymentIntent();
        } else {
            return $this->___callPlugins('createPaymentIntent', func_get_args(), $pluginInfo);
        }
    }
