...
class Interceptor extends \StripeIntegration\Payments\Model\Method\Ach implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'deduplicateBankAccounts');
        if (!$pluginInfo) {
            return parent::deduplicateBankAccounts($customer, $token);
        } else {
            return $this->___callPlugins('deduplicateBankAccounts', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'adjustParamsForMethod');
        if (!$pluginInfo) {
            return parent::adjustParamsForMethod($params, $payment, $order, $quote);
        } else {
            return $this->___callPlugins('adjustParamsForMethod', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRedirectUrlFrom');
        if (!$pluginInfo) {
            return parent::getRedirectUrlFrom($source);
        } else {
            return $this->___callPlugins('getRedirectUrlFrom', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function cancel(\Magento\Payment\Model\InfoInterface $payment, $amount = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::cancel($payment, $amount);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBillingDetails');
        if (!$pluginInfo) {
            return parent::getBillingDetails();
        } else {
            return $this->___callPlugins('getBillingDetails', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTestEmail');
        if (!$pluginInfo) {
            return parent::getTestEmail();
        } else {
            return $this->___callPlugins('getTestEmail', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTestName');
        if (!$pluginInfo) {
            return parent::getTestName();
        } else {
            return $this->___callPlugins('getTestName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isEmailValid');
        if (!$pluginInfo) {
            return parent::isEmailValid($email);
        } else {
            return $this->___callPlugins('isEmailValid', func_get_args(), $pluginInfo);
        }
    }
