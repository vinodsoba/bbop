...
class Interceptor extends \StripeIntegration\Payments\Model\Method\Klarna implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'associateSourceWithOrder');
        if (!$pluginInfo) {
            return parent::associateSourceWithOrder($payment);
        } else {
            return $this->___callPlugins('associateSourceWithOrder', func_get_args(), $pluginInfo);
        }
    }
