<?php
namespace Ess\M2ePro\Block\Adminhtml\ControlPanel\Info\Mysql\Integration;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\ControlPanel\Info\Mysql\Integration
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\ControlPanel\Info\Mysql\Integration implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getInfoTables');
        if (!$pluginInfo) {
            return parent::getInfoTables();
        } else {
            return $this->___callPlugins('getInfoTables', func_get_args(), $pluginInfo);
        }
    }
