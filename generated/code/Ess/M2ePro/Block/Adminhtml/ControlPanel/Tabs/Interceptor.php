...
/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\ControlPanel\Tabs
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\ControlPanel\Tabs implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_toHtml');
        if (!$pluginInfo) {
            return parent::_toHtml();
        } else {
            return $this->___callPlugins('_toHtml', func_get_args(), $pluginInfo);
        }
    }
