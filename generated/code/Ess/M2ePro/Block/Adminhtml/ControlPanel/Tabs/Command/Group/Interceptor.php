<?php
namespace Ess\M2ePro\Block\Adminhtml\ControlPanel\Tabs\Command\Group;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\ControlPanel\Tabs\Command\Group
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\ControlPanel\Tabs\Command\Group implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCommandLauncherHtml');
        if (!$pluginInfo) {
            return parent::getCommandLauncherHtml($commandRow, $component);
        } else {
            return $this->___callPlugins('getCommandLauncherHtml', func_get_args(), $pluginInfo);
        }
    }
