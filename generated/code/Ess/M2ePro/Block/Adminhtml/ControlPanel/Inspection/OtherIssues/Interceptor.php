...
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\ControlPanel\Inspection\OtherIssues implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Ess\M2ePro\Block\Adminhtml\Magento\Context\Template $context, \Magento\Framework\App\ResourceConnection $resourceConnection, array $data = [])
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isShown');
        if (!$pluginInfo) {
            return parent::isShown();
        } else {
            return $this->___callPlugins('isShown', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isMagicQuotesEnabled');
        if (!$pluginInfo) {
            return parent::isMagicQuotesEnabled();
        } else {
            return $this->___callPlugins('isMagicQuotesEnabled', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isGdLibraryUnAvailable');
        if (!$pluginInfo) {
            return parent::isGdLibraryUnAvailable();
        } else {
            return $this->___callPlugins('isGdLibraryUnAvailable', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isZendOpcacheAvailable');
        if (!$pluginInfo) {
            return parent::isZendOpcacheAvailable();
        } else {
            return $this->___callPlugins('isZendOpcacheAvailable', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isSystemLogNotEmpty');
        if (!$pluginInfo) {
            return parent::isSystemLogNotEmpty();
        } else {
            return $this->___callPlugins('isSystemLogNotEmpty', func_get_args(), $pluginInfo);
        }
    }
