...
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Ebay\Listing\View\Ebay\Grid implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnEbayItemId');
        if (!$pluginInfo) {
            return parent::callbackColumnEbayItemId($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnEbayItemId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnOnlineAvailableQty');
        if (!$pluginInfo) {
            return parent::callbackColumnOnlineAvailableQty($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnOnlineAvailableQty', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnOnlineQtySold');
        if (!$pluginInfo) {
            return parent::callbackColumnOnlineQtySold($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnOnlineQtySold', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnEndTime');
        if (!$pluginInfo) {
            return parent::callbackColumnEndTime($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnEndTime', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getViewLogIconHtml');
        if (!$pluginInfo) {
            return parent::getViewLogIconHtml($listingProductId);
        } else {
            return $this->___callPlugins('getViewLogIconHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getTooltipHtml($content, $id = '')
    {
        ...
        if (!$pluginInfo) {
            return parent::getTooltipHtml($content, $id);
        } else {
