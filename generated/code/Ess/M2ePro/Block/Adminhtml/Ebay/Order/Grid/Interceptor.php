<?php
namespace Ess\M2ePro\Block\Adminhtml\Ebay\Order\Grid;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Ebay\Order\Grid
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Ebay\Order\Grid implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\ResourceConnection $resourceConnection, \Ess\M2ePro\Model\ActiveRecord\Component\Parent\Ebay\Factory $ebayFactory, \Ess\M2ePro\Block\Adminhtml\Magento\Context\Template $context, \Magento\Backend\Helper\Data $backendHelper, array $data = [])
    {
        $this->___init();
        parent::__construct($resourceConnection, $ebayFactory, $context, $backendHelper, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnMagentoOrder');
        if (!$pluginInfo) {
            return parent::callbackColumnMagentoOrder($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnMagentoOrder', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackPurchaseCreateDate');
        if (!$pluginInfo) {
            return parent::callbackPurchaseCreateDate($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackPurchaseCreateDate', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnEbayOrder');
        if (!$pluginInfo) {
            return parent::callbackColumnEbayOrder($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnEbayOrder', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnItems');
        if (!$pluginInfo) {
            return parent::callbackColumnItems($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnItems', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnBuyer');
        if (!$pluginInfo) {
            return parent::callbackColumnBuyer($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnBuyer', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnTotal');
        if (!$pluginInfo) {
            return parent::callbackColumnTotal($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnTotal', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnShipping');
        if (!$pluginInfo) {
            return parent::callbackColumnShipping($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnShipping', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnCheckoutStatus');
        if (!$pluginInfo) {
            return parent::callbackColumnCheckoutStatus($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnCheckoutStatus', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnPayment');
        if (!$pluginInfo) {
            return parent::callbackColumnPayment($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnPayment', func_get_args(), $pluginInfo);
        }
    }
