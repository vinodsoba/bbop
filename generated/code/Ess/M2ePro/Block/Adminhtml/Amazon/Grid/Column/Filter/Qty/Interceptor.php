<?php
namespace Ess\M2ePro\Block\Adminhtml\Amazon\Grid\Column\Filter\Qty;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Amazon\Grid\Column\Filter\Qty
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Amazon\Grid\Column\Filter\Qty implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Ess\M2ePro\Helper\Factory $helperFactory, \Ess\M2ePro\Model\Factory $modelFactory, \Magento\Backend\Block\Context $context, \Magento\Framework\DB\Helper $resourceHelper, array $data = [])
    {
        $this->___init();
    ...
    public function getCondition()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getCondition', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setColumn($column)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('setColumn', func_get_args(), $pluginInfo);
        }
    }
