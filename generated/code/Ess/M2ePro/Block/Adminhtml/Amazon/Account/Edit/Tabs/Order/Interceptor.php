...
/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Amazon\Account\Edit\Tabs\Order
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Amazon\Account\Edit\Tabs\Order implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Tax\Model\ClassModel $taxClass, \Magento\Customer\Model\Group $customerGroup, \Magento\Sales\Model\Order\Config $orderConfig, \Ess\M2ePro\Block\Adminhtml\Magento\Context\Template $context, \Magento\Framework\Registry $registry, \Magento\Framework\Data\FormFactory $formFactory, array $data = [])
    {
        $this->___init();
        parent::__construct($taxClass, $customerGroup, $orderConfig, $context, $registry, $formFactory, $data);
    }
