<?php
namespace Ess\M2ePro\Block\Adminhtml\Amazon\Settings\Tabs\Synchronization;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Amazon\Settings\Tabs\Synchronization
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Amazon\Settings\Tabs\Synchronization implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isShowReviseAll');
        if (!$pluginInfo) {
            return parent::isShowReviseAll();
        } else {
            return $this->___callPlugins('isShowReviseAll', func_get_args(), $pluginInfo);
        }
    }
