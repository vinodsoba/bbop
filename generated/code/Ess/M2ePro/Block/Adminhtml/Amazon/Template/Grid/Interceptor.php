<?php
namespace Ess\M2ePro\Block\Adminhtml\Amazon\Template\Grid;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Amazon\Template\Grid
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Amazon\Template\Grid implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($wrapperCollectionFactory, $amazonFactory, $resourceConnection, $context, $backendHelper, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnMarketplace');
        if (!$pluginInfo) {
            return parent::callbackColumnMarketplace($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnMarketplace', func_get_args(), $pluginInfo);
        }
    }
