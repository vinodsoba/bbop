...
/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Amazon\Template\SellingFormat\Edit\Form
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Amazon\Template\SellingFormat\Edit\Form implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Customer\Model\Group $customerGroup, \Ess\M2ePro\Block\Adminhtml\Magento\Context\Template $context, \Magento\Framework\Registry $registry, \Magento\Framework\Data\FormFactory $formFactory, array $data = [])
    {
        $this->___init();
        parent::__construct($customerGroup, $context, $registry, $formFactory, $data);
    }
