...
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Amazon\Order\View\Form implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Store\Model\StoreManager $storeManager, \Ess\M2ePro\Block\Adminhtml\Magento\Context\Widget $context, array $data = [])
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isCurrencyAllowed');
        if (!$pluginInfo) {
            return parent::isCurrencyAllowed();
        } else {
            return $this->___callPlugins('isCurrencyAllowed', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasCurrencyConversionRate');
        if (!$pluginInfo) {
            return parent::hasCurrencyConversionRate();
        } else {
            return $this->___callPlugins('hasCurrencyConversionRate', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function formatPrice($currencyName, $priceValue)
    {
        ...
        if (!$pluginInfo) {
            return parent::formatPrice($currencyName, $priceValue);
        } else {
