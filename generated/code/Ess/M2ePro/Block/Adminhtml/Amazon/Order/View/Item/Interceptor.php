...
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Amazon\Order\View\Item implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnProduct');
        if (!$pluginInfo) {
            return parent::callbackColumnProduct($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnProduct', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnOriginalPrice');
        if (!$pluginInfo) {
            return parent::callbackColumnOriginalPrice($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnOriginalPrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnGiftPrice');
        if (!$pluginInfo) {
            return parent::callbackColumnGiftPrice($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnGiftPrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnDiscountAmount');
        if (!$pluginInfo) {
            return parent::callbackColumnDiscountAmount($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnDiscountAmount', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnGiftOptions');
        if (!$pluginInfo) {
            return parent::callbackColumnGiftOptions($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnGiftOptions', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnRowTotal');
        if (!$pluginInfo) {
            return parent::callbackColumnRowTotal($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnRowTotal', func_get_args(), $pluginInfo);
        }
    }
