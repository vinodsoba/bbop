...
/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Amazon\Order\Grid
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Amazon\Order\Grid implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\ResourceConnection $resourceConnection, \Ess\M2ePro\Model\ActiveRecord\Component\Parent\Amazon\Factory $amazonFactory, \Ess\M2ePro\Block\Adminhtml\Magento\Context\Template $context, \Magento\Backend\Helper\Data $backendHelper, array $data = [])
    {
        $this->___init();
        parent::__construct($resourceConnection, $amazonFactory, $context, $backendHelper, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnAmazonOrderId');
        if (!$pluginInfo) {
            return parent::callbackColumnAmazonOrderId($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnAmazonOrderId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnAfnChannel');
        if (!$pluginInfo) {
            return parent::callbackColumnAfnChannel($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnAfnChannel', func_get_args(), $pluginInfo);
        }
    }
