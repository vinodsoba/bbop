<?php
namespace Ess\M2ePro\Block\Adminhtml\Amazon\Listing\Log\Grid\LastActions;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Amazon\Listing\Log\Grid\LastActions
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Amazon\Listing\Log\Grid\LastActions implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\ResourceConnection $resourceConnection, \Ess\M2ePro\Block\Adminhtml\Magento\Context\Template $context, array $data = [])
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTip');
        if (!$pluginInfo) {
            return parent::getTip();
        } else {
            return $this->___callPlugins('getTip', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIconSrc');
        if (!$pluginInfo) {
            return parent::getIconSrc();
        } else {
            return $this->___callPlugins('getIconSrc', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getEncodedRows');
        if (!$pluginInfo) {
            return parent::getEncodedRows();
        } else {
            return $this->___callPlugins('getEncodedRows', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getViewHelpHandler');
        if (!$pluginInfo) {
            return parent::getViewHelpHandler();
        } else {
            return $this->___callPlugins('getViewHelpHandler', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCloseHelpHandler');
        if (!$pluginInfo) {
            return parent::getCloseHelpHandler();
        } else {
            return $this->___callPlugins('getCloseHelpHandler', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getHideViewLogLink');
        if (!$pluginInfo) {
            return parent::getHideViewLogLink();
        } else {
            return $this->___callPlugins('getHideViewLogLink', func_get_args(), $pluginInfo);
        }
    }
