...
/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Amazon\Listing\View
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Amazon\Listing\View implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddProductsDropDownItems');
        if (!$pluginInfo) {
            return parent::getAddProductsDropDownItems();
        } else {
            return $this->___callPlugins('getAddProductsDropDownItems', func_get_args(), $pluginInfo);
        }
    }
