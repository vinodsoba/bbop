<?php
namespace Ess\M2ePro\Block\Adminhtml\Amazon\Listing\View\Switcher;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Amazon\Listing\View\Switcher
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Amazon\Listing\View\Switcher implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStyle');
        if (!$pluginInfo) {
            return parent::getStyle();
        } else {
            return $this->___callPlugins('getStyle', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDefaultParam');
        if (!$pluginInfo) {
            return parent::getDefaultParam();
        } else {
            return $this->___callPlugins('getDefaultParam', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSelectedParam');
        if (!$pluginInfo) {
            return parent::getSelectedParam();
        } else {
            return $this->___callPlugins('getSelectedParam', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSwitchCallbackName');
        if (!$pluginInfo) {
            return parent::getSwitchCallbackName();
        } else {
            return $this->___callPlugins('getSwitchCallbackName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSwitchCallback');
        if (!$pluginInfo) {
            return parent::getSwitchCallback();
        } else {
            return $this->___callPlugins('getSwitchCallback', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getParamPlaceHolder');
        if (!$pluginInfo) {
            return parent::getParamPlaceHolder();
        } else {
            return $this->___callPlugins('getParamPlaceHolder', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDefaultOptionName');
        if (!$pluginInfo) {
            return parent::getDefaultOptionName();
        } else {
            return $this->___callPlugins('getDefaultOptionName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDefaultOptionValue');
        if (!$pluginInfo) {
            return parent::getDefaultOptionValue();
        } else {
            return $this->___callPlugins('getDefaultOptionValue', func_get_args(), $pluginInfo);
        }
    }
