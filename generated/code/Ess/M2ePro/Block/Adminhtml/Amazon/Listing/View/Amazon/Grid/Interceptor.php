<?php
namespace Ess\M2ePro\Block\Adminhtml\Amazon\Listing\View\Amazon\Grid;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Amazon\Listing\View\Amazon\Grid
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Amazon\Listing\View\Amazon\Grid implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function callbackColumnProductTitle($productTitle, $row, $column, $isExport)
    {
        ...
        if (!$pluginInfo) {
            return parent::callbackColumnProductTitle($productTitle, $row, $column, $isExport);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnAmazonSku');
        if (!$pluginInfo) {
            return parent::callbackColumnAmazonSku($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnAmazonSku', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnGeneralId');
        if (!$pluginInfo) {
            return parent::callbackColumnGeneralId($generalId, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnGeneralId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnAvailableQty');
        if (!$pluginInfo) {
            return parent::callbackColumnAvailableQty($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnAvailableQty', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getViewLogIconHtml($listingProductId, $isVariationParent)
    {
        ...
        if (!$pluginInfo) {
            return parent::getViewLogIconHtml($listingProductId, $isVariationParent);
        } else {
    ...
    public function getTooltipHtml($content, $id = '', $classes = [])
    {
        ...
        if (!$pluginInfo) {
            return parent::getTooltipHtml($content, $id, $classes);
        } else {
