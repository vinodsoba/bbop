<?php
namespace Ess\M2ePro\Block\Adminhtml\Amazon\Listing\Search\Product\Grid;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Amazon\Listing\Search\Product\Grid
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Amazon\Listing\Search\Product\Grid implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnActions');
        if (!$pluginInfo) {
            return parent::callbackColumnActions($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnActions', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function callbackColumnGeneralId($value, $row, $column, $isExport)
    {
        ...
        if (!$pluginInfo) {
            return parent::callbackColumnGeneralId($value, $row, $column, $isExport);
        } else {
