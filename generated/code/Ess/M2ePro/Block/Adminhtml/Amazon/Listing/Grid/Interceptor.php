<?php
namespace Ess\M2ePro\Block\Adminhtml\Amazon\Listing\Grid;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Amazon\Listing\Grid
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Amazon\Listing\Grid implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Ess\M2ePro\Model\ActiveRecord\Component\Parent\Amazon\Factory $amazonFactory, \Ess\M2ePro\Block\Adminhtml\Magento\Context\Template $context, \Magento\Backend\Helper\Data $backendHelper, array $data = [])
    {
        $this->___init();
        parent::__construct($amazonFactory, $context, $backendHelper, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnSoldProducts');
        if (!$pluginInfo) {
            return parent::callbackColumnSoldProducts($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnSoldProducts', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnTitle');
        if (!$pluginInfo) {
            return parent::callbackColumnTitle($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnTitle', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnTotalProducts');
        if (!$pluginInfo) {
            return parent::callbackColumnTotalProducts($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnTotalProducts', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnListedProducts');
        if (!$pluginInfo) {
            return parent::callbackColumnListedProducts($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnListedProducts', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callbackColumnInactiveProducts');
        if (!$pluginInfo) {
            return parent::callbackColumnInactiveProducts($value, $row, $column, $isExport);
        } else {
            return $this->___callPlugins('callbackColumnInactiveProducts', func_get_args(), $pluginInfo);
        }
    }
