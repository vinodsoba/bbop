<?php
namespace Ess\M2ePro\Block\Adminhtml\Amazon\Listing\Create\Selling\Form;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Amazon\Listing\Create\Selling\Form
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Amazon\Listing\Create\Selling\Form implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Ess\M2ePro\Model\ActiveRecord\Component\Parent\Amazon\Factory $amazonFactory, \Ess\M2ePro\Block\Adminhtml\Magento\Context\Template $context, \Magento\Framework\Registry $registry, \Magento\Framework\Data\FormFactory $formFactory, array $data = [])
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDefaultFieldsValues');
        if (!$pluginInfo) {
            return parent::getDefaultFieldsValues();
        } else {
            return $this->___callPlugins('getDefaultFieldsValues', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setUseFormContainer');
        if (!$pluginInfo) {
            return parent::setUseFormContainer($useFormContainer);
        } else {
            return $this->___callPlugins('setUseFormContainer', func_get_args(), $pluginInfo);
        }
    }
