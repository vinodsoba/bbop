<?php
namespace Ess\M2ePro\Block\Adminhtml\Developers\Tabs\CronJobDetails;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Developers\Tabs\CronJobDetails
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Developers\Tabs\CronJobDetails implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Ess\M2ePro\Block\Adminhtml\Magento\Context\Template $context, \Magento\Framework\Registry $registry, \Magento\Framework\Data\FormFactory $formFactory, array $data = [])
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isShownRecommendationsMessage');
        if (!$pluginInfo) {
            return parent::isShownRecommendationsMessage();
        } else {
            return $this->___callPlugins('isShownRecommendationsMessage', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isShownServiceDescriptionMessage');
        if (!$pluginInfo) {
            return parent::isShownServiceDescriptionMessage();
        } else {
            return $this->___callPlugins('isShownServiceDescriptionMessage', func_get_args(), $pluginInfo);
        }
    }
