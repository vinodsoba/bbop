<?php
namespace Ess\M2ePro\Block\Adminhtml\Developers\Tabs\SystemRequirements;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Developers\Tabs\SystemRequirements
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Developers\Tabs\SystemRequirements implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\FormFactory $formFactory, \Ess\M2ePro\Block\Adminhtml\Magento\Context\Template $context, array $data = [])
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getManager');
        if (!$pluginInfo) {
            return parent::getManager();
        } else {
            return $this->___callPlugins('getManager', func_get_args(), $pluginInfo);
        }
    }
