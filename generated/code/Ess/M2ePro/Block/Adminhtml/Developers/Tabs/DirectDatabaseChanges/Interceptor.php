<?php
namespace Ess\M2ePro\Block\Adminhtml\Developers\Tabs\DirectDatabaseChanges;

/**
 * Interceptor class for @see \Ess\M2ePro\Block\Adminhtml\Developers\Tabs\DirectDatabaseChanges
 */
class Interceptor extends \Ess\M2ePro\Block\Adminhtml\Developers\Tabs\DirectDatabaseChanges implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Ess\M2ePro\Model\Config\Manager\Synchronization $synchronizationConfig, \Ess\M2ePro\Block\Adminhtml\Magento\Context\Template $context, \Magento\Framework\Registry $registry, \Magento\Framework\Data\FormFactory $formFactory, array $data = [])
    {
        $this->___init();
        parent::__construct($synchronizationConfig, $context, $registry, $formFactory, $data);
    }
