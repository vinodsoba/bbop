define([
    ...
    window.WalmartTemplateCategoryCategoriesSpecificBlockGridAddSpecificRenderer = Class.create(WalmartTemplateCategoryCategoriesSpecificRenderer, {
        ...
        addSpecificAction: function(event)
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_template_category/getAddSpecificsHtml'), {
                method: 'post',
                parameters: {
        ...
        openPopUp: function(html)
        {
            ...
            if (!M2ePro.popUp) {
                ...
                M2ePro.popUp = jQuery(modalDialogMessage)
                    .modal({
        ...
        reloadSearchingGrid: function(query, onlyDesired)
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_template_category/getAddSpecificsGridHtml'), {
                method: 'post',
                parameters: {
                    marketplace_id          : $('marketplace_id').value,
                    product_data_nick       : $('product_data_nick').value,
