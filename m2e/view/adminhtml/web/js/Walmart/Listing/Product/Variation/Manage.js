define([
    ...
    window.WalmartListingProductVariationManage = Class.create(Action, {
        ...
        openPopUp: function (productId, title, filter)
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation/manage'), {
                method: 'post',
                parameters: {
        ...
        openVocabularyAttributesPopUp: function (attributes)
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation_vocabulary/getAttributesPopup'), {
                onSuccess: function (transport) {
        ...
        addAttributesToVocabulary: function (needAdd)
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation_vocabulary/addAttributes'), {
                method: 'post',
                parameters: {
        ...
        openVocabularyOptionsPopUp: function (options)
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation_vocabulary/getOptionsPopup'), {
                onSuccess: function (transport) {
        ...
        addOptionsToVocabulary: function (needAdd)
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation_vocabulary/addOptions'), {
                method: 'post',
                parameters: {
        ...
        openSkuPopUp: function () {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation_manage/getSkuPopup'), {
                method: 'post',
                parameters: {
        ...
        setProductSku: function ()
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation_manage/setListingProductSku'), {
                method: 'post',
                parameters: data,
                onSuccess: function (transport) {
        ...
        setChannelAttributes: function()
        {
            ...
            if(result) {
                ...
                new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation_manage/setChannelAttributes'), {
                    method: 'post',
                    parameters: data,
                    onSuccess: function (transport) {
                        var response = self.parseResponse(transport);
        ...
        setSwatchImagesAttribute: function()
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation_manage/setSwatchImagesAttribute'), {
                method: 'post',
                parameters: {
                    product_id: self.variationProductManagePopup.productId,
                    attribute: el.value
        ...
        setMatchedAttributes: function ()
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation_manage/setMatchedAttributes'), {
                method: 'post',
                parameters: data,
                onSuccess: function (transport) {
                    var response = self.parseResponse(transport);
            ...
            $H(self.matchedAttributes).each(function (attribute) {
                ...
                var tr = new Element('tr'),
                    ...
                    selectVirtualAttributeOption = new Element('select', {
                        ...
                        disabled: 'disabled',
                        class: 'admin__control-select required-entry virtual-walmart-option',
                    ...
                    selectWalmartAttr = new Element('select', {
                        class: 'admin__control-select required-entry M2ePro-walmart-attribute-unique-value walmart-attribute-name',
                ...
                selectWalmartAttr.observe('change', function (event) {
                    ...
                    if (selectWalmartAttr.value != '' && inputMagentoAttr.value != selectWalmartAttr.value &&
                        ...
                        if (attribute.value == null) {
                            self.alert(M2ePro.translator.translate('duplicate_walmart_attribute_error'));
                        }
        ...
        showVirtualMagentoAttributes: function (lastAttributeIndex)
        {
            ...
            self.destinationAttributes.each(function (attribute) {
                ...
                spanLeftHelpIcon.update(helpIconTpl.innerHTML);
                spanLeftHelpIcon.down('.tool-tip-message-text').update(M2ePro.translator.translate('help_icon_walmart_greater_left'));
                spanRightHelpIcon.update(helpIconTpl.innerHTML);
                spanRightHelpIcon.down('.tool-tip-message-text').update(M2ePro.translator.translate('help_icon_walmart_greater_right'));
        ...
        reloadSettings: function (callback)
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation_manage/viewVariationsSettingsAjax'), {
                method: 'post',
                parameters: {
                    product_id: self.variationProductManagePopup.productId
                },
        ...
        reloadVocabulary: function ()
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation_vocabulary/viewVocabularyAjax'), {
                method: 'post',
                parameters: {
                    product_id: self.variationProductManagePopup.productId
                },
        ...
        {
            new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation_manage/saveAutoActionSettings'), {
                method: 'post',
        ...
        removeAttributeFromVocabulary: function (el)
        {
            ...
            self.confirm({
                actions: {
                    confirm: function () {
                        new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation_vocabulary/removeAttribute'), {
                            method: 'post',
                            parameters: {
        ...
        removeOptionFromVocabulary: function (el)
        {
            ...
            self.confirm({
                actions: {
                    confirm: function () {
                        new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation_vocabulary/removeOption'), {
                            method: 'post',
                            parameters: {
